...
public class TPCWProperties {
	...
	public String writeQueue;   // Public IP address of Master node
	public String readQueue[];  // Public IP address of Master node and all Slave nodes
	public String candidateQueue[];  // Public IP address of the Candidate node

	public String username;
	public String password;

	public int destroyerSleepInterval;
	public String destroyTarget;     // Public Ip address of the Master node. 

	public int load_balancer_type;
	...
	public void checkPropertiesFileAndGetURLGenerator() {
		try {
			...
			load_balancer_type = Integer.parseInt(getProperty("load_balancer_type"));
		} catch (Exception e) {
